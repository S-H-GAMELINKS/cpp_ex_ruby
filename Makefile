...
srcdir = .
topdir = /home/sh/.rbenv/versions/2.6.2/include/ruby-2.6.0
hdrdir = $(topdir)
arch_hdrdir = /home/sh/.rbenv/versions/2.6.2/include/ruby-2.6.0/x86_64-linux
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/home/sh/.rbenv/versions/2.6.2
...
LOCAL_LIBS = 
LIBS =   -lm   -lc
ORIG_SRCS = hello.cpp hello_wrapper.cpp
SRCS = $(ORIG_SRCS) 
OBJS = hello.o hello_wrapper.o
HDRS = $(srcdir)/hello.hpp
LOCAL_HDRS = 
TARGET = Hello
TARGET_NAME = Hello
